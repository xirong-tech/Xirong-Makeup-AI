...
from imagine.imagine.color.extract import ClusteringColorExtractor, GeometricMedianColorExtractor
from imagine.imagine.shape import operations
from imagine.imagine.shape.segment import ClusteringSegmenter
